...
set_target_properties(ortools::ortools PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libortools.so.8.1.8487"
  IMPORTED_SONAME_RELEASE "libortools.so.8"
  )

list(APPEND _IMPORT_CHECK_TARGETS ortools::ortools )
list(APPEND _IMPORT_CHECK_FILES_FOR_ortools::ortools "${_IMPORT_PREFIX}/lib/libortools.so.8.1.8487" )
...
set_target_properties(ortools::flatzinc PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libflatzinc.so.8.1.8487"
  IMPORTED_SONAME_RELEASE "libflatzinc.so.8"
  )

list(APPEND _IMPORT_CHECK_TARGETS ortools::flatzinc )
list(APPEND _IMPORT_CHECK_FILES_FOR_ortools::flatzinc "${_IMPORT_PREFIX}/lib/libflatzinc.so.8.1.8487" )
